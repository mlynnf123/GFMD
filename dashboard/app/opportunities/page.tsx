  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight gradient-text">Opportunities</h1>
          <p className="text-muted-foreground mt-1">
            Detailed view of all sales opportunities with filtering and sorting
          </p>
        </div>
        <Button 
          className="glossy-button"
          onClick={() => alert('Create New Opportunity coming soon!\n\nThis will allow you to manually add new sales opportunities to track.')}
        >
          New Opportunity
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <MetricCard
          ...
          description="Opportunity to lead"
        />
      ...
      <div className="metric-card">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h4 className="text-lg font-semibold mb-2">No Opportunities</h4>
            <p className="text-muted-foreground mb-4">
              Your AI discovery engine will identify sales opportunities automatically.
            </p>
            <Button onClick={() => alert('Manual Opportunity Creation coming soon!\n\nFor now, opportunities are discovered automatically by the AI engine.')}>
              Create Opportunity
            </Button>
          </div>
        ) : (

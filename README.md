...
A high-performance, multi-agent AI system for automated B2B sales outreach to healthcare facilities.
...
Automatically:
1. **Researches** healthcare facilities using AI
...
- **Email**: Gmail API
- **Data**: 10,283 healthcare contacts from Definitive Healthcare
...
### 3 AI Agents:
1. **Research Agent** - Analyzes facilities, finds pain points
...
- `definitive_healthcare_data.csv` - 10K contacts
...
at Abbott Northwestern Hospital. Our centrifuges are designed to run
quieter and take up less space, which can help with OSHA compliance

#!/usr/bin/env python3
"""
GFMD Firestore Migration Script
Migrates healthcare contacts from CSV to Firestore database
"""
...
def main():
    ...
    try:
        ...
        contacts_list = df_clean.to_dict('records')
        ...
        logger.info(f"Total contacts in database: {stats.get('total_contacts', 0)}")
